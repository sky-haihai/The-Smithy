...
public class myweapon
{
    ...
    public myweapon(string name, int no, int level, int stat_addition1, int stat_addition2
        , int stat_addition3, int effect_addition1, int effect_addition2,myskill myskill)
    {
        this.name = name;
        this.no = no;
        this.level = level;
